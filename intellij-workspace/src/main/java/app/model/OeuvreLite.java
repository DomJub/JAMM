...
public class OeuvreLite extends Oeuvre {
    ...
    /*final private SimpleStringProperty titre;
    final private SimpleStringProperty note;
    final private SimpleStringProperty origine;*/
    @Override
    ...
    /*public OeuvreLite(String titre, Integer note, String origine){
        ...
        this.origine = new SimpleStringProperty();
    }*/
    public OeuvreLite(){
